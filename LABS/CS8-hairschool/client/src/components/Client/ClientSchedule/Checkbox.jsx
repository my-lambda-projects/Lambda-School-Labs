...
//
//                
//                <li style={{listStyleType: "none"}}><Button className="Button" bsSize="large">Cut & Color $30</Button></li>
//                <li style={{listStyleType: "none"}}><Button className= "Button" bsSize="large">Extensions $40</Button></li>
//                <li style={{listStyleType: "none"}}><Button className= "Button" bsSize="large">Color $20</Button></li>
//                <li style={{listStyleType: "none"}}><Button className= "Button" bsSize="large">Barbering $20</Button></li>
//            </div>
//        );
//    }
//}