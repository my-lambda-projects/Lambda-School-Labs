        ...
        <Div>
          <div>
            ...
            <div>
              <Input
                ...
                border={errors.cpr && '2px solid red'}
                name="cpr"
                defaultValue={student.cpr}
                ref={register({ required: true, minLength: 9, maxLength: 9 })}
              />
              {errors.cpr && errors.cpr.type === 'required' && 'ID is required.'}
              {errors.cpr &&
                (errors.cpr.type === 'minLength' || errors.cpr.type === 'maxLength') &&
                'ID needs to be 9 characters'}
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div>
              ...
              <Input
                type="text"
                border={errors.additional_names && '2px solid red'}
                name="additional_names"
                defaultValue={student.additional_names}
                ref={register({ required: true, pattern: /^([a-zA-Z]+ +){0,}([a-zA-Z]+ ?)$/i })}
              />
              {errors.additional_names &&
                errors.additional_names.type === 'required' &&
                'Additional Names are required.'}
              {errors.additional_names &&
                errors.additional_names.type === 'pattern' &&
                'Enter at least 1 additional name.'}
            </div>
          </div>
          <div>
            <Label>Gender</Label>
          ...
          <div>
            ...
            <div>
              <Input
                type="tel"
                border={errors.phone_number && '2px solid red'}
                name="phone_number"
          ...
          <div>
            ...
            <div>
              <Input
                type="date"
                border={errors.birthdate && '2px solid red'}
                name="birthdate"
          ...
          <div>
            ...
            <div>
              <Input
                type="text"
                border={errors.school_name && '2px solid red'}
                name="school_name"
          ...
          <div style={{ gridColumn: 'span 3' }}>
            ...
            <div>
              <Input
                type="text"
                border={errors.address && '2px solid red'}
                name="address"
          ...
          <div style={{ gridColumn: 'span 2' }}>
            ...
            <div>
              <Input
                type="text"
                border={errors.primary_emergency_contact_name && '2px solid red'}
                name="primary_emergency_contact_name"
                defaultValue={student.primary_emergency_contact_name}
                ref={register({ required: true })}
              />
          ...
          <div>
            ...
            <div>
              <Input
                type="text"
                border={errors.primary_emergency_relationship && '2px solid red'}
                name="primary_emergency_relationship"
                defaultValue={student.primary_emergency_relationship}
                ref={register({ required: true })}
              />
          ...
          <div>
            ...
            <div>
              <Input
                type="tel"
                border={errors.primary_emergency_phone && '2px solid red'}
                name="primary_emergency_phone"
                defaultValue={student.primary_emergency_phone}
                ref={register({ required: true })}
              />
          ...
          <div>
            ...
            <div>
              <Input
                ...
                defaultValue={student.emergency_relationship}
                ref={register}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              <select
                className="dropDown"
                name="delinquent"
                defaultValue={student.delinquent}
                ref={register({ required: true })}
              >
                {createDropdown(yesNoDropdown)}
              </select>
