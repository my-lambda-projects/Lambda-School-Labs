                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 offset-lg-2 text-center">
                            ...
                            <p className="section-subtitle font-secondary text-white text-center padding-t-30">Join in the discusssions today! </p>
                            <Link to="" onClick = { toggleRegisterModal } className="btn btn-bg-white waves-effect margin-t-20 mb-4">Get Started <i className="mdi mdi-arrow-right"></i> </Link>
                        </div>
                    </div>
                </div>
